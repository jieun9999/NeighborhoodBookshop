    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_introduction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View view2 = LayoutInflater.from(MainActivity.this).inflate(R.layout.userprofile_introduction_add_dialog, null, false);
                // 빌더 객체에서 뷰를 보여줍니다.
        ...
        textView_insta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                // R.layout.alert_dialog 레이아웃을 인플레이트하여 대화상자에 표시할 뷰를 설정합니다.
                View view2 = LayoutInflater.from(MainActivity.this).inflate(R.layout.userprofile_insta_add_dialog, null, false);
                // 빌더 객체에서 뷰를 보여줍니다.
                builder.setView(view2);
                //dialog 변수를 사용하여 AlertDialog를 표시하거나 닫을 수 있습니다.
                // 예를 들어, dialog.show()를 호출하여 AlertDialog를 화면에 표시하거나 dialog.dismiss()를 호출하여 AlertDialog를 닫음
            ...
            View view = inflater.inflate(R.layout.book_add_dialog, null, false);
